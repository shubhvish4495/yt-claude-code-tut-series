...
Analyze the README.md file in the current project and follow the setup instructions to run the application locally with all required dependencies. Give preference to Docker for databases and external services when available.

## Instructions

1. **Read and Analyze README.md**
   - Parse the README.md file to understand the project setup requirements
...
2. **Database and Service Setup (Prefer Docker)**
   ...
   - Follow Docker setup instructions from README.md if provided
...
3. **Environment Configuration**
   - Set up required environment variables as specified in README.md
...
4. **Dependency Installation**
   - Install project dependencies using the package manager specified in README.md
...
6. **Application Startup**
   ...
   - Use the run commands specified in README.md (make run, npm start, go run, etc.)
...
- **Follow README**: Strictly follow the setup instructions provided in the project's README.md
